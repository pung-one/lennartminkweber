...
export const texts: TextData[] = [
  {
    ...
    text: (
      <>
        <h1>How Objects Become Passwords</h1>

        <p>
          <i>Lonely Planet Boy</i> by Lennart Mink Weber (2022) is composed of
          four rectangular fields. On the upper left and lower right, the panels
          are made of aluminium sheets covered with black pinstripe fabric. On
          the left panel, blind rivets are attached to the fabric in irregular
          circles. Across the right panel, an aluminium section slightly
          overhangs the picture frame to the outside. On the two other panels,
          on the lower left and upper right, the aluminium sheets have been left
          bare, which, unlike the dull fabric, reflects light. Blind rivets are
          again attached to the lower left panel, and five cylinders cast in
          different diameters of green and yellow plastic are attached to the
          upper right panel.
        </p>
        ...
        <p>
          ...
          does a romantic allusion reconcile with the objectivity of an
          industrial product? Aren't they contradictory? The individual fields
          are partially framed by aluminium strips. One bar divides the image
          vertically, the other crosses the lower black field diagonally. The
          ledges create the impression of imbalance, movement, and
          incompleteness, which is enhanced by the constantly changing
          reflection of light.
        </p>
        ...
        <p>
          ...
          such as <i>Riv</i>. They live from the tension between the final form
          and the rotation inherent in each spiral movement. Another example
          would be <i>Schiffer</i>, a four-meter tall pole reminiscent of a boat
          mast and made of riveted aluminium sections, to which door handles
          cast in resin are attached at an intangible height. What is their
          possible function? <i>"To catch light"</i>, says the artist.
        </p>

        <p>
          And why does the artist refer to <i>the password</i> as a suitable
          figure of thought in relation to his objects? Is it because, similar
          to the password, its semantic meaning as a word, number or sign is
          cancelled by its function? But for every question asked, another
  ...
  },
  {
    ...
    text: (
      <p>
        ...
        the earth and felt metal on metal. As they dropped to their knees and
        scooped the dirt from whatever it was they had found, their minds must
        have raced with imaginings of untold treasures. Even still, what lay
        waiting would surpass the stuff of fantasy and while both men would
        receive prison sentences for their plundering, they had in fact
        uncovered one of archaeology's greatest-ever finds: a bronze disc, 30cm
        in diameter and dotted in gold with what is immediately recognisable as
        a sun, a moon and 32 stars.
        <br />
        <br />
        ...
        of the Landesmuseum für Vorgeschichte in Halle. Subsequent testing has
        suggested the disc might have originally been stained black: the vacuum
        of space contrasting against the disc's golden cosmological features to
        create what would have been a sacred object of the highest importance.
        ...
        the degree) solstice-indicative positions as on the Nebra disc. While
        modern techniques have allowed us to date such objects and sites
        ...
        walking amongst its henge-like solstice markers. At one point, though,
        he accidentally transported himself to another connected site. “Schon
        wieder bei Stonehenge”, he said, apparently unaware that others watched
        on as he stumbled around a circular room wearing large, ill-fitting
        goggles. His disappointment at such a miraculous teleportation seemed to
        ...
        circular formation of big rocks. This phenomena is not limited to the
        Sky Disc or England's neolithic national treasure. It's the thrill of
        the chase, it's the every-detail-accounted-for work of art, the
        level-headed explanation of natural phenomena: magic exists, if even
        only in our own wandering imaginations. That is, of course, until it's
        explained away. There is the argument that it is human kind's penchant
        for story-telling, the spiritual aspect of humanity, that separates us
        from previous versions of ourselves. Or that defines us. After all, what
        are we without our stories? Earlier species of the homo genus possessed
        ...
        life into it. As we speak to it, it to us. Did Weber make the work or
        have we? In that sense it seems almost a collaborative effort: a union.
        But then an an orchestrated union. Weber seduces us into the work with
        highly-crafted handling of material: the contrast of polished aluminium
        against deadened cloth - its riveted cosmos shining back at us. The
        coolness of space and of metal again juxtaposed by the warmth of
        amber-toned resin. A close-up of the adjoining galactic snapshot? Or a
        view from the plane's window down to a sleeping population? Both? The
        artist offers enough here that one wants to connect the dots and indeed
        begins to do so. But as the lines between points are drawn, it becomes
        apparent that no pre-defined Disney character will materialise into
        existence. Although Weber has deliberately and delicately placed each
        point for us to connect, what that connection process produces is
        entirely up to us.
      </p>
    ),
  },
